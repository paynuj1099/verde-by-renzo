...
export default function ProfilePage() {
  ...
  if (!user)
    return (
      <main className="min-h-screen bg-gray-50 pt-32 text-center">
        <p className="mb-4 text-gray-600">Sign in to view your profile.</p>
        ...
        <div className="overflow-hidden rounded-2xl bg-white shadow-xl">
          ...
          <div className="px-6 pb-8 sm:px-10">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <h1 className="font-serif text-3xl text-forest-800">{name}</h1>
              <span
                className={`rounded-full px-3 py-1 text-xs font-semibold uppercase ${isAdmin ? "bg-gold-100 text-gold-700" : "bg-forest-50 text-forest-700"}`}
              >
            ...
            <div className="mt-8 space-y-3 rounded-xl bg-gray-50 p-5">
              <div className="flex items-center gap-3 text-gray-700">
                <User size={19} className="text-forest-600" />
                <span>{name}</span>
              </div>
              <div className="flex items-center gap-3 text-gray-700">
                <Mail size={19} className="text-forest-600" />
                <span className="break-all">{user.email}</span>
              </div>
              <div className="flex items-center gap-3 text-gray-700">
                <ShieldCheck size={19} className="text-forest-600" />
                <span>
                  {user.emailVerified ? "Verified" : "Unverified"} · Signed in
                  with {provider}
                </span>
              </div>
            </div>
              ...
              <section className="mt-6 rounded-xl border border-gold-200 bg-gold-50 p-5">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Manage the Firestore catalog and review the public
                    storefront.
                  </p>
                </div>
                      ...
                      >
                        <div>
                          ...
                          <p className="text-xs text-gray-500">
                            {order.createdAt
                              ?.toDate()
                              .toLocaleDateString("en-PH") || "Processing"}
                          </p>
                        </div>
