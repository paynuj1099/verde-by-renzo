          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm text-forest-600 hover:text-forest-700 font-medium transition-colors">
                  Forgot password?
                </Link>
              </div>
            ...
            <p className="text-center text-sm text-gray-600 mt-6">
              ...
              <Link href="/signup" className="text-forest-600 hover:text-forest-700 font-semibold transition-colors">
                Create one
              </Link>
            </p>
          </div>
